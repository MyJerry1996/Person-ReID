...
def train_model(model, dataloader, criterion, optimizer, scheduler, use_gpu, num_epochs=25):
    ######################################################################
    # Training the model
    # ------------------
    #
...
if __name__ == '__main__':
    ...
    train_model(model, criterion, optimizer, scheduler, use_gpu, num_epochs=60)
