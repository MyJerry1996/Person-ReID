...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir',default='..\\..\\dataset\\Market-1501-v15.09.15\\pytorch',type=str, help='training dir path')
    ...
    parser.add_argument('--PCB', action='store_true', help='use PCB+ResNet50' )   #action='store_true'的意思为：如果不写参数，PCB默认为FALSE的，写了才置为TRUE
    ...
    def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
        ...
        for epoch in range(num_epochs):
            ...
            viz.scatter(X=np.array([[epoch,y_loss['train'][-1]]]),name="train",win=win_loss,update='append')
            viz.scatter(X=np.array([[epoch,y_loss['val'][-1]]]), name="val", win=win_loss, update='append')
